...
# Define a function to apply rotation and translation (and clipping) in order to show the rover position in worldmap.
...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,0] = obs_map * 225
    Rover.vision_image[:,:,1] = rock_sample * 225 
    Rover.vision_image[:,:,2] = threshed * 225
    # 5) Convert map image pixel values to rover-centric coords
    xpix, ypix = rover_coords(threshed)
    # 6) Convert rover-centric pixel values to world coordinates with size of (200 x 200 x 3)
    ...
    if rock_map.any():
        ...
        Rover.worldmap[rock_ycen, rock_xcen, 1] = 225
